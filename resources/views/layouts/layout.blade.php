...
<head>
    ...
    <link rel="icon" href="{{ asset('images/assets/logowk.png') }}" type="image/x-icon">
    {{-- CDN Bootstrap --}}
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container">
            <a class="navbar-brand" href="">
                <img src="{{ asset('images/assets/logowk.png') }}" alt="Logo" width="30" height="30" class="me-2 ms-3">DATA SISWA
              </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('index_data.index')}}">Data Siswa</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('kelola_akun.index')}}">Kelola Akun</a>
                    </li>
                </ul>
            </div>
        </div>
