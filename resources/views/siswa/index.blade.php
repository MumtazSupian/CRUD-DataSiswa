...
@section('content-dinamis')
    <div class="container mt-5">
        <div class="d-flex justify-content-end">
            ...
            <a href="{{ route('index_data.create') }}" class="btn btn-success">+ Tambah Data Siswa</a>
        </div>
        ...
        <table class="table table-stripped table-bordered mt-3 text-center">
            ...
            <tbody>
                {{-- @if (count($siswa) == 0)
                    <tr>
                        <td colspan="6">Data Siswa Kosong</td>
                    </tr>
                @else --}}
                    @php
                        $no = 1;
                    ...
                    @foreach ($siswa as $index => $item)
                        <tr>
                            ...
                            <td class="d-flex justify-content-center">
                                <a href="{{ route('index_data.edit', $item->id)}}" class="btn btn-primary me-2">Edit</a>
...
<script>
    function showModalDelete(id,nama) {
        ...
        let url = "{{ route('index_data.delete', ':id') }}";
